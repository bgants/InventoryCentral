...
class BackendStack(Stack):
    def __init__(
        ...
        **kwargs,
        ...
        id = products.add_resource("{id}")
        id.add_method("GET")  # GET /products/{id}
        id.add_method("PUT")  # PUT /products/{id}
        id.add_method("DELETE")  # DELETE /products/{id}
        ...
        apigateway.BasePathMapping(
            self, "ApiMapping", domain_name=api_domain, rest_api=api
        )
        ...
        CfnOutput(self, "APIGatewayURL", value=f"https://{api_domain.domain_name}")
